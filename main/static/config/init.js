...
;(function() {
  var resList = {
    ...
    css: [
      ...
      window.SITE_CONFIG.cdnUrl + '/static/iconFont/iconfont.css',
    ],
    js: [
      // 插件, 放置业务之前加载, 以免业务需求依赖插件时, 还未加载出错
      // 阿里矢量图
      window.SITE_CONFIG.cdnUrl + '/static/iconFont/iconfont.js',
      // 插件 - echarts
      window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-3.8.5/echarts.common.min.js',
      // 插件 - g2
      window.SITE_CONFIG.cdnUrl + '/static/plugins/g2-4.1.14/g2.common.min.js',
      // 插件 - ueditor
